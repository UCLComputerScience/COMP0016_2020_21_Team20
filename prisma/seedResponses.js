  ...
  await Promise.all([
    prisma.responses.create({
      data: {
        ...
        words: {
          create: [
            { word: 'Hello', questions: { connect: { id: 8 } } },
            { word: 'Hola', questions: { connect: { id: 8 } } },
            { word: 'Bonjour', questions: { connect: { id: 8 } } },
            { word: 'Toto', questions: { connect: { id: 9 } } },
            { word: 'Michele', questions: { connect: { id: 9 } } },
            { word: 'Paul', questions: { connect: { id: 9 } } },
          ],
        },
      },
    }),
